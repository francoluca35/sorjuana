  ...
  const tabBtn = (id: MainTab, label: string) => (
    <button
      ...
      className={cn(
        ...
        mainTab === id ? 'text-teal-600' : 'text-slate-500 hover:text-slate-700',
      )}
    >
      {label}
      {mainTab === id ? (
  ...
  return (
    <div className="flex min-h-dvh flex-col text-slate-900" style={{ fontFamily: sans }}>
      <header className="flex flex-none flex-wrap items-center justify-between gap-3 border-b border-slate-200/90 bg-white/90 px-4 pb-5 pt-6 sm:px-6 sm:pb-6 sm:pt-7">
        ...
        <Button
          asChild
          className="rounded-md bg-[#b8956a] px-4 text-sm font-medium text-white hover:bg-teal-700"
        >
          ...
          {draft ? (
            <>
                ...
                <div className="mt-4 flex gap-6 border-b border-transparent">
                  <button
                    ...
                    className={cn(
                      ...
                      drawerTab === 'registro' ? 'text-teal-600' : 'text-slate-500',
                    )}
                  >
                    Registro
                  ...
                  <button
                    ...
                    className={cn(
                      'relative pb-2 text-xs font-semibold uppercase tracking-wide',
                      drawerTab === 'stock' ? 'text-teal-600' : 'text-slate-500',
                    )}
                  >
                    Stock
              ...
              <SheetFooter className="border-t border-slate-100 bg-slate-50/80 px-4 py-4 sm:px-6">
                <Button type="button" className="w-full bg-teal-600 py-5 text-base font-semibold text-white hover:bg-teal-700" onClick={saveDraft}>
                  Guardar
                </Button>
              </SheetFooter>
            </>
