...
import { ArrowUpRight, Instagram, Plus, ShoppingCart, X } from 'lucide-react';
...
const INSTAGRAM_URL =
  'https://www.instagram.com/libertesorjuana?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==';
const TIKTOK_URL = 'https://www.tiktok.com/@libertesorjuana';
    ...
    >
      ...
      <div className="pointer-events-auto absolute bottom-[max(1rem,env(safe-area-inset-bottom))] right-20 z-30 flex items-center gap-2 md:bottom-8 md:right-24">
        <a
          ...
          className="flex h-11 w-11 items-center justify-center text-white transition hover:border-white/70 hover:bg-black/60"
