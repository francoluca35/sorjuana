            ...
            {[
              {
                title: 'El Origen',
                year: '2015',
                text: 'Sor Juana nació con una visión clara: acercar la moda europea de alta calidad a mujeres que buscan elegancia y distinción. Inspirados en la poetisa mexicana, representamos sofisticación en cada prenda.'
              },
              {
