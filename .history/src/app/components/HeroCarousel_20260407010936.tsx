...
type HeroOffer = {
  ...
  /** MP4 URL (muted loop); `image` se usa como poster y fallback. */
  videoSrc?: string;
};
...
export function HeroCarousel() {
  ...
  const [autoplayMs, setAutoplayMs] = useState(6000);
  ...
  const settings = {
    ...
    afterChange: (index: number) => {
      setAutoplayMs(offers[index]?.videoSrc ? 15000 : 6000);
