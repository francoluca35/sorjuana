        ...
        <div className="flex flex-col justify-center bg-[#f5f2ed] px-6 py-12 sm:px-12 lg:px-16 xl:px-24">
          <div className="mx-auto w-full max-w-md">
            ...
            <form onSubmit={onSubmit} className="mt-12 space-y-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    'placeholder:text-[#a89080]/80 focus:border-[#1a1410]',
                  )}
                  style={{ fontFamily: sans }}
                  placeholder=""
                />
              ...
              <Button
                type="submit"
                className="h-12 w-full rounded-none border-0 bg-[#1a1410] text-xs font-medium tracking-[0.35em] text-[#f5f2ed] uppercase shadow-none hover:bg-[#3d3530]"
                style={{ fontFamily: sans }}
              >
                Entrar
              </Button>
