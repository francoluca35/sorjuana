                  ...
                  {[
                    {
                      icon: MapPin,
                      title: 'Dirección',
                      content: [...siteAddressLines],
                    },
                    {
                      icon: Phone,
                      title: 'WhatsApp',
                      content: [sitePhoneDisplay, 'Lunes a sábado: 10:00 - 20:00 h'],
                    ...
                    >
                      ...
                      <div>
                        ...
                        {item.content.map((line, i) => (
                          'href' in item && item.href && i === 0 ? (
                            <a
                              key={i}
                              href={item.href}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="block text-[#6b6156] transition hover:text-[#b8956a]"
                              style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 400 }}
                            >
                              {line}
                            </a>
          ...
          >
            <div className="h-full min-h-[600px] bg-white overflow-hidden border-4 border-[#b8956a]/20 relative">
              ...
              <iframe
                ...
                title="Ubicación Sor Juana — ESI, Juncal 417, Merlo"
              />
            </div>
          </motion.div>
        </div>
