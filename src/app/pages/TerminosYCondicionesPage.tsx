...
import type { TermsConditionsConfig } from '@/lib/termsConditionsConfig';

const serif = "'Cormorant Garamond', serif";

export function TerminosYCondicionesPage({ terms }: { terms: TermsConditionsConfig }) {
	return (
		<main className="relative min-h-dvh bg-[#f5f2ed] pb-20 pt-12 text-[#2a2520] sm:pt-14">
			...
			<div className="mx-auto max-w-3xl px-4 pt-8 sm:px-6 sm:pt-10 lg:px-8">
				...
				<ReturnPolicyContent policy={terms} />
			</div>
		</main>
	);
}
